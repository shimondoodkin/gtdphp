...
$config = array(
    ...
    //user preferences : MOVE TO DATABASE
        ...
        "debug"                     => 'false',  // false | true | developer | freezedb
		...
		"storeRecurrences"			=> true,  // false | true - when recurring items are completed, store each occurrence as a completed item
		"trimLength"				=> 72     // max visible length of descriptions when listing items
        );
