...
if ($type=="v" && $Id>0) {
	...
	$cquery = "SELECT visionId as cId from visionlookup WHERE valueId='$Id'";
	}
	...
	$cquery = "SELECT goalId as cId from goallookup WHERE visionId='$Id'";
	}
	...
	$cquery = "SELECT projectId as cId from rslookup WHERE respId='$Id'";
	}
